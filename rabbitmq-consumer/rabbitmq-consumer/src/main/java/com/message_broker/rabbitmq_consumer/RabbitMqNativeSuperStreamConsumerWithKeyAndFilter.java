...
@Component
public class RabbitMqNativeSuperStreamConsumerWithKeyAndFilter {
    private static final Logger LOGGER = LoggerFactory.getLogger(RabbitMqNativeSuperStreamConsumerWithKeyAndFilter.class);
    ...
    public RabbitMqNativeSuperStreamConsumerWithKeyAndFilter(Environment streamEnvironment) {
    ...
    public void start() {
        this.consumer = streamEnvironment.consumerBuilder()
                .superStream("userSuperStreamWithRoutingKey")
